...
/*!
  @name AES Core Error String
  Access to the standardized and predefined error strings for the AES Library
 */
///@{
/*!
...
/*!
  @name S-box definitions
  Allows access to the predefined and set S-box and inverse S-box
 */
///@{
/*!
  @brief Returns a byte transformed by the S-box

  Transforms the input byte using the AES S-box. The S-box is defined as follows:
  @code
...
/*!
  ...
  Transforms the input byte using the AES inverse S-box. The inverse of the S-box is defined as follows:
  @code
...
/*!
  @name Sub and Rot Words
  Substitute and Rotate words (`4 bytes`) based on the functions defined in the AES algorithm
 */
/// @{
/*!
